...
namespace CameraProjectionRenderingToolkit {
	...
	public class CPRT : MonoBehaviour {
		...
		private float prelockNearPlane=0.0f,prelockFarPlane=0.0f;//si non 0, on a influ� artificiellement le near / far plane
		...
		public void OnRenderImage(RenderTexture source,RenderTexture destination) {
			...
			//r�active le contr�le des r�glage de camera de unity
			ResetCameraSettings();
			...
			switch (proj_type) {
				case CPRTType.Stereospherical: {
					...
					if (offz>0.0f) {
						...
						observerFOV=Mathf.Rad2Deg*CPRTToolkit.ComputeStereosphericalProjFOV(widthAperture,fieldOfViewY*Mathf.Deg2Rad,Aspect,-offz);//*Mathf.Deg2Rad ajout� le 06/05/2021
